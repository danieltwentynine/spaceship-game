...
#creating bullet - ready state: bullet not visible - fire state: bullet visible
...
def game_over_text(x, y):
    ...
    restart = font.render("Press R to Restart or Q to Quit", True, (255, 255, 255))
...
while running:
    ...
    for event in pygame.event.get(): #gets an event occuring on the screen (mouse or keyboard)
